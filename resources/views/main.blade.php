    ...
    <div id="cajaPrincipal">
        <section id="seccionUno">
            ...
            <button type="button" role="button" tabindex="0" class="brbsPe Ss7qXc a-qb-d" aria-disabled="false"
                aria-expanded="false" aria-haspopup="true" guidedhelpid="new_menu_button" style="user-select: none;"><i
                ...
                <div id="categoria">
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><button class="dropdown-item" type="button">TipoArchivo1</button></li>
                            <li><button class="dropdown-item" type="button">TipoArchivo2</button></li>
                            <li><button class="dropdown-item" type="button">TipoArchivo3</button></li>
                        </ul>
                    </div>
                    <div class="dropdown">
                        <button class="btn btn-secondary dropdown-toggle" type="button" data-bs-toggle="dropdown"
                        ...
                        <ul class="dropdown-menu">
                            <li><button class="dropdown-item" type="button">Usuario1</button></li>
                            <li><button class="dropdown-item" type="button">Usuario2</button></li>
                            <li><button class="dropdown-item" type="button">Usuario3</button></li>
                        </ul>
                    </div>
                    <div class="dropdown">
                        <button class="btn btn-secondary dropdown-toggle" type="button" data-bs-toggle="dropdown"
                            ...
                            <table id="tablaProductos" class="table table-striped table-hover mt-4">
                                ...
                                <tbody>
                                            <tr>
                                                ...
                                                <td><i class="fa-regular fa-folder" style="margin-right: 4%"></i> Carpeta1</td>
                                                <th><i class="fa-solid fa-user-plus" > <i class="fa-solid fa-pen-to-square"></i> <i class="fa-regular fa-star"></i>  <i class="fa-solid fa-trash"></i></i></th>
                                            </tr>
                                </tbody>
                            </table>
                        </div>
